...
import com.kalika.ojbackendjudgeservice.judge.codesandbox.CodeSandboxFactory;
import com.kalika.ojbackendjudgeservice.judge.codesandbox.CodeSandboxProxy;
...
public class JudgeServiceImpl implements JudgeService {
    ...
    public QuestionSubmit doJudge(long questionSubmitId) {
        ...
        String judgeInfoJson = questionSubmitUpdate.getJudgeInfo();
        System.out.println(judgeInfoJson);
        try {
            // 将字符串解析为JSON对象
            JSONObject json = new JSONObject(judgeInfoJson);
            // 获取message属性的值
